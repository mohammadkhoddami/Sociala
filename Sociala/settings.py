"""
Django settings for Sociala project.
...
SECRET_KEY = 'django-insecure-q*5md_nmonu4r!em%ewb0j5^auru_yf))gqh-&1(e7nvak%ubd'
...
WSGI_APPLICATION = 'Sociala.wsgi.application'
